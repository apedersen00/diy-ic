...
value="
.option savecurrents
.save all @n.xm2.nsg13_lv_nmos[ids] @n.xm2.nsg13_lv_nmos[l] @n.xm2.nsg13_lv_nmos[gm] @n.xm2.nsg13_lv_nmos[cgg] @n.xm2.nsg13_lv_nmos[gds]
.control
...
while actual_L le stop_L
	alter @n.xm2.nsg13_lv_nmos[l] = actual_L
	let actual_VDS = start_VDS
	while actual_VDS le stop_VDS
		alter VDS actual_VDS
		dc VGS 0 3.3 0.01
		wrdata lv_nmos.txt v(VDS) v(VGS) @n.xm2.nsg13_lv_nmos[ids] @n.xm2.nsg13_lv_nmos[l] @n.xm2.nsg13_lv_nmos[gm] @n.xm2.nsg13_lv_nmos[cgg] @n.xm2.nsg13_lv_nmos[gds]
...
"}
C {ngspice_get_value.sym} 10 -10 0 0 {name=r1 node=i(@n.xm2.nsg13_lv_nmos[ids])}
