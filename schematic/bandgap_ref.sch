...
N 120 140 120 160 {lab=v+}
N -120 340 -120 360 {lab=vss}
N 0 360 120 360 {lab=vss}
N 120 340 120 360 {lab=vss}
N -120 140 -120 260 {lab=v-}
N -120 140 -80 140 {lab=v-}
N -80 290 20 290 {lab=v+}
N 20 140 20 290 {lab=v+}
N 20 140 120 140 {lab=v+}
N 0 0 80 -0 {lab=vo}
N 0 0 -0 40 {lab=vo}
N -120 -50 -120 -30 {lab=vdd}
N 0 -80 120 -80 {lab=vdd}
N 120 -50 120 -30 {lab=vdd}
N -0 -120 0 -80 {lab=vdd}
N 0 360 -0 400 {lab=vss}
N 120 120 300 120 {lab=v+}
N 300 120 300 160 {lab=v+}
N 120 360 300 360 {lab=vss}
N 300 220 300 360 {lab=vss}
N 360 -50 360 -30 {lab=vdd}
N 280 0 320 -0 {lab=vo}
N 120 -80 360 -80 {lab=vdd}
N 480 120 480 160 {lab=vbgr}
N 480 220 480 360 {lab=vss}
N 300 360 480 360 {lab=vss}
N 360 30 360 120 {lab=vbgr}
N 360 120 480 120 {lab=vbgr}
N 480 120 660 120 {lab=vbgr}
N 660 120 660 160 {lab=vbgr}
N 660 220 660 360 {lab=vss}
N 480 360 660 360 {lab=vss}
N 660 120 720 120 {lab=vbgr}
N -120 30 -120 140 {lab=v-}
N 120 120 120 140 {lab=v+}
N -80 -0 0 0 {lab=vo}
N -120 -80 0 -80 {lab=vdd}
N -120 360 0 360 {lab=vss}
N 120 30 120 120 {lab=v+}
...
N 120 -80 120 -50 {lab=vdd}
N 360 -0 380 0 {lab=vdd}
N 380 -50 380 -0 {lab=vdd}
N 360 -50 380 -50 {lab=vdd}
N 360 -80 360 -50 {lab=vdd}
N -140 290 -120 290 {lab=vss}
N -140 290 -140 340 {lab=vss}
N -140 340 -120 340 {lab=vss}
N -120 320 -120 340 {lab=vss}
N 120 290 140 290 {lab=vss}
N 140 290 140 340 {lab=vss}
N 120 340 140 340 {lab=vss}
N 120 320 120 340 {lab=vss}
...
C {lab_pin.sym} 280 0 0 0 {name=p5 sig_type=std_logic lab=vo}
...
C {ipin.sym} 20 140 0 0 {name=p1 lab=v+}
C {ipin.sym} -80 140 0 1 {name=p3 lab=v-}
